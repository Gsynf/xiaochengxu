...
public class PushController {
    ...
    public String push(@RequestParam String openid, @RequestParam String formid) {
        ...
        wxConfig.setAppid("wx41e0e2a5adc999e3");//小程序appid
        wxConfig.setSecret("e98669d61ed3f8e39b508f0f59d2b20d");//小程序AppSecret
        ...
        WxMaTemplateData data1 = new WxMaTemplateData("keyword1", "宝贝早上好");
